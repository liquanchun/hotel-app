...
import { StoreinaddService } from './storeinadd.services';
...
@Component({
  selector: 'app-qt-storeinadd',
  templateUrl: './storeinadd.component.html',
  styleUrls: ['./storeinadd.component.scss'],
  providers: [StoreinaddService, HouseinfoService, ReadIdCardService, HouseTypeService, SetPaytypeService, DicService],
})
export class StoreinaddComponent implements OnInit {
  ...
  constructor(
    ...
    private _storeinaddService: StoreinaddService,
  ...
  onConfirm(): void {
    ...
    this.isSaved = true;
    const that = this;
    this._storeinaddService.create(
      {
