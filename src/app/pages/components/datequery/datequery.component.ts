...
@Component({
    ...
    <button (click)="onClick($event)" type="button" class="btn btn-info btn-sm"><i class="fa fa-angle-left" aria-hidden="true"></i> 昨天</button>
    <button (click)="onClick($event)" type="button" class="btn btn-info btn-sm"><i class="fa fa-angle-down" aria-hidden="true"></i> 今天</button>
    <button (click)="onClick($event)" type="button" class="btn btn-info btn-sm"><i class="fa fa-angle-double-left" aria-hidden="true"></i> 上周</button>
