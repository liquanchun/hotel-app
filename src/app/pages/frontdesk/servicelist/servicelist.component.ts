...
import { ServiceList } from './servicelist.services';
...
@Component({
  ...
  providers: [ServiceList,ServiceItemService],
})
export class ServiceListComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private _serviceList: ServiceList,
  ...
  loadData(orderNo: string) {
    this._serviceList.getSelectServices(orderNo).then((data) => {
